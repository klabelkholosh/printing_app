...
class AddressController extends Controller
{
     ...
     *
     * @Route("/{addressnumber}", name="address_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{addressnumber}/edit", name="address_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Address $address)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('address_edit', array('addressnumber' => $address->getAddressnumber()));
        }
     ...
     *
     * @Route("/{addressnumber}", name="address_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Address $address)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('address_delete', array('addressnumber' => $address->getAddressnumber())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
