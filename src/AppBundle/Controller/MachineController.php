...
class MachineController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('machine_show', array('machinecode' => $machine->getMachinecode()));
        }
     ...
     *
     * @Route("/{machinecode}", name="machine_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{machinecode}/edit", name="machine_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Machine $machine)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('machine_edit', array('machinecode' => $machine->getMachinecode()));
        }
     ...
     *
     * @Route("/{machinecode}", name="machine_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Machine $machine)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('machine_delete', array('machinecode' => $machine->getMachinecode())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
